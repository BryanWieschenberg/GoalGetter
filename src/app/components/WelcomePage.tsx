...
export default function WelcomePage() {
    return (
        <div className="min-h-screen flex flex-col items-center bg-gradient-to-b from-blue-50 to-white dark:from-zinc-800 dark:to-black text-zinc-900 dark:text-zinc-100">
